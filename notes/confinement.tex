...
\begin{figure}[h!]
	\centering
	\textbf{FLEXIBLE} \\
	(a)~\includegraphics[width=0.28\linewidth]{g_r_2D_6_46_f_1_1} 
	(b)~\includegraphics[width=0.28\linewidth]{g_r_2D_7_46_f_1_1}
	(c)~\includegraphics[width=0.28\linewidth]{g_r_2D_8_46_f_1_1}
	\textbf{RIGID} \\
	(d)~\includegraphics[width=0.28\linewidth]{g_r_2D_6_46_r_1_1} 
	(e)~\includegraphics[width=0.28\linewidth]{g_r_2D_7_46_r_1_1}
	(f)~\includegraphics[width=0.28\linewidth]{g_r_2D_8_46_r_1_1}
	\vspace{-10pt}
...
\begin{figure}[h!]
	\centering
	\textbf{FLEXIBLE} \\
	(a)~\includegraphics[trim={0.35cm 0.25cm 0.75cm 0.15cm},clip,width=0.20\linewidth]{dgg_v_x_6_46_f} 
	(b)~\includegraphics[trim={0.35cm 0.25cm 0.75cm 0.15cm},clip,width=0.20\linewidth]{dgg_v_x_9_46_f}
	(c)~\includegraphics[trim={0.35cm 0.25cm 0.75cm 0.15cm},clip,width=0.20\linewidth]{dgg_v_x_10_46_f}
	(d)~\includegraphics[trim={0.35cm 0.25cm 0.75cm 0.15cm},clip,width=0.20\linewidth]{dgg_v_x_12_46_f}
	\textbf{RIGID} \\
	(e)~\includegraphics[trim={0.35cm 0.25cm 0.75cm 0.15cm},clip,width=0.20\linewidth]{dgg_v_x_6_46_r} 
	(f)~\includegraphics[trim={0.35cm 0.25cm 0.75cm 0.15cm},clip,width=0.20\linewidth]{dgg_v_x_9_46_r}
	(g)~\includegraphics[trim={0.35cm 0.25cm 0.75cm 0.15cm},clip,width=0.20\linewidth]{dgg_v_x_10_46_r}
	(h)~\includegraphics[trim={0.35cm 0.25cm 0.75cm 0.15cm},clip,width=0.20\linewidth]{dgg_v_x_12_46_r}
	\vspace{-10pt}
