...
\begin{figure}[h!]
	...
	(d)~\includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=0.14\linewidth]{dgg_fit_14_46_f} \\  \vspace{-10pt} 
	\textbf{RIGID} \\
...
%\end{figure}
 ...
 \textbf{RIGID} \\
  ...
  \end{subfigure}
  \begin{subfigure}[b]{0.15\textwidth}
    \includegraphics[width=.99\textwidth]{g_r_10_46_r_o_o}
     \vspace{-15pt} \caption{}
    \label{fig:rg_12_r}
  \end{subfigure}
  \begin{subfigure}[b]{0.15\textwidth}
