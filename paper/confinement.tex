...
\begin{figure}[h!]
	...
	\begin{subfigure}[b]{0.49\textwidth}
    		\includegraphics[trim={0.35cm 0.25cm 0.05cm 0.05cm},clip,width=.99\textwidth]{d_gg_r}
     		\caption{}
    		\label{fig:dgg_1}
  	\end{subfigure}
	\begin{subfigure}[b]{0.49\textwidth}
    		\includegraphics[width=.99\textwidth]{dgg_snaps6}
     		\caption{}
    		\label{fig:dgg_2}
  	\end{subfigure}
	\caption{\textit{Plot and snapshots of average graphene-graphene separation as a function of 2D-number density.} \textbf{(\protect\subref{fig:dgg_1})} Plot of average graphene-graphene separation as a function of 2D-number density. Multi refers to the instances in the flexible case where coexistence between multiple numbers of water layers was observed. \textbf{(\protect\subref{fig:dgg_2}, left)} Snapshots of water-graphene systems as a function of increasing 2D-density, water oxygens are red, graphene carbons are grey and water hydrogens are not displayed for clarity. Magenta diamonds correspond to flexible systems of 2D-densities with multiple numbers of water layers. Images not drawn to size. \textbf{(\protect\subref{fig:dgg_2}, right)} 2D histogram of the distance of water to a reference wall versus the graphene-graphene separation distance, warmer colors representing a higher number of observations.}
	\label{fig:dgg}
\end{figure}
...
\begin{figure}[h!]
  ...
  \begin{subfigure}[b]{0.278\textwidth}
    \includegraphics[trim={0.25cm 0.25cm 0.25cm 0.15cm},clip,width=0.99\textwidth]{g_r_2D_6_7_8_1_1_r}
    \includegraphics[trim={0.25cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_6_7_8_r}
    \caption{}
    \label{fig:gr_ang_6_7_8_r}
  \end{subfigure}
  \begin{subfigure}[b]{0.22\textwidth}
    \includegraphics[trim={1.05cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{g_r_2D_9_10_11_1_1_r}
    \includegraphics[trim={1.05cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_9_10_11_r}
   \caption{}
    \label{fig:gr_ang_9_10_11_r}
  \end{subfigure} 
    \begin{subfigure}[b]{0.22\textwidth}
    \includegraphics[trim={1.05cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{g_r_2D_12_14_16_1_1_r}
    \includegraphics[trim={1.05cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_12_14_16_r}
    \caption{}
    \label{fig:gr_ang_12_14_16_r}
  \end{subfigure} \\  
	\textbf{FLEXIBLE} \\
  \begin{subfigure}[b]{0.278\textwidth}
    \includegraphics[trim={0.25cm 0.25cm 0.25cm 0.15cm},clip,width=0.99\textwidth]{g_r_2D_6_7_8_1_1_f}
    \includegraphics[trim={0.25cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_6_7_8_f}
    \caption{}
    \label{fig:gr_ang_6_7_8_f}
  \end{subfigure}
  \begin{subfigure}[b]{0.22\textwidth}
    \includegraphics[trim={1.05cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{g_r_2D_9_10_11_1_1_f}
    \includegraphics[trim={1.05cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_9_10_11_f}
   \caption{}
    \label{fig:gr_ang_9_10_11_f}
  \end{subfigure} 
    \begin{subfigure}[b]{0.22\textwidth}
    \includegraphics[trim={1.05cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{g_r_2D_12_14_16_1_1_f}
...
%	\centering
%	\textbf{FLEXIBLE} \\
%	(a)~\includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=0.15\linewidth]{dgg_fit_6_46_f} 
%	(b)~\includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=0.15\linewidth]{dgg_fit_9_46_f}
%	(c)~\includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=0.15\linewidth]{dgg_fit_10_46_f}
%	(d)~\includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=0.15\linewidth]{dgg_fit_12_46_f}
%	(d)~\includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=0.15\linewidth]{dgg_fit_14_46_f} \\  \vspace{-5pt} 
%	\textbf{RIGID} \\
%	(f)~\includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=0.15\linewidth]{dgg_fit_6_46_r} 
%	(g)~\includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=0.15\linewidth]{dgg_fit_9_46_r}
%	(h)~\includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=0.15\linewidth]{dgg_fit_10_46_r}
%	(i)~\includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=0.15\linewidth]{dgg_fit_12_46_r}
%	(j)~\includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=0.15\linewidth]{dgg_fit_14_46_r}
...
%    \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_6_46_f}
%    \vspace{-15pt} \caption{}
%    \label{fig:ang_6_f}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_7_46_f}
%     \vspace{-15pt} \caption{}
%    \label{fig:ang_7_f}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_8_46_f}
%    \vspace{-15pt} \caption{}
%    \label{fig:ang_8_f}
%  \end{subfigure}
%    \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_9_46_f}
%    \vspace{-15pt} \caption{}
%    \label{fig:ang_9_f}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_12_46_f}
%     \vspace{-15pt} \caption{}
%    \label{fig:ang_12_f}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_14_46_f}
%    \vspace{-15pt} \caption{}
%    \label{fig:ang_14_f}
...
% \textbf{RIGID} \\
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_6_46_r}
%     \vspace{-15pt} \caption{}
%    \label{fig:ang_6_r}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_7_46_r}
%     \vspace{-15pt} \caption{}
%    \label{fig:ang_7_r}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_8_46_r}
%    \vspace{-15pt} \caption{}
%    \label{fig:ang_8_r}
%  \end{subfigure}
%   \begin{subfigure}[b]{0.15\textwidth}
%  \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_9_46_r}
%    \vspace{-15pt} \caption{}
%    \label{fig:ang_9_r}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_12_46_r}
%     \vspace{-15pt} \caption{}
%    \label{fig:ang_12_r}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_14_46_r}
%    \vspace{-15pt} \caption{}
%    \label{fig:ang_14_r}
%  \end{subfigure}\\
%	\caption{\textit{3-body angle distribution functions} Distribution of angle formed between nearest neighbors  (\protect\subref{fig:rg_6_f},\protect\subref{fig:rg_6_r})  \(\rho_{2D}\) = 0.065 (\protect\subref{fig:ang_7_f},\protect\subref{fig:ang_7_r}) \(\rho_{2D}\) = 0.097 (\protect\subref{fig:ang_8_f},\protect\subref{fig:ang_8_r}) \(\rho_{2D}\) = 0.129, (\protect\subref{fig:ang_9_f},\protect\subref{fig:ang_9_r}) \(\rho_{2D}\) = 0.163, (\protect\subref{fig:ang_12_f},\protect\subref{fig:ang_12_r}) \(\rho_{2D}\) = 0.260 (\protect\subref{fig:ang_14_f},\protect\subref{fig:ang_14_r}) \(\rho_{2D}\) = 0.325.}
...
%	   \textbf{FLEXIBLE} \\
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_10_46_f}
%    \vspace{-15pt} \caption{}
%    \label{fig:ang_10_f}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_11_46_f}
%     \vspace{-15pt} \caption{}
%    \label{fig:ang_11_f}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_13_46_f}
%    \vspace{-15pt} \caption{}
%    \label{fig:ang_13_f}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_16_46_f}
%     \vspace{-15pt} \caption{}
%    \label{fig:ang_16_f}
%  \end{subfigure} \\     \vspace{-10pt} 
% \textbf{RIGID} \\
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_10_46_r}
%     \vspace{-15pt} \caption{}
%    \label{fig:ang_10_r}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_11_46_r}
%     \vspace{-15pt} \caption{}
%    \label{fig:ang_11_r}
%  \end{subfigure}
%    \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_13_46_r}
%     \vspace{-15pt} \caption{}
%    \label{fig:ang_13_r}
%  \end{subfigure}
%   \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=.99\textwidth]{ang_3B_16_46_r}
%     \vspace{-15pt} \caption{}
%    \label{fig:ang_16_r}
%  \end{subfigure}\\
%	\caption{\textit{3-body angle distribution functions} Distribution of angle formed between nearest neighbors  (\protect\subref{fig:ang_10_f},\protect\subref{fig:ang_10_r})  \(\rho_{2D}\) = 0.196 (\protect\subref{fig:ang_11_f},\protect\subref{fig:ang_11_r}) \(\rho_{2D}\) = 0.227 (\protect\subref{fig:ang_13_f},\protect\subref{fig:ang_13_r}) \(\rho_{2D}\) = 0.293, (\protect\subref{fig:ang_16_f},\protect\subref{fig:ang_16_r}) \(\rho_{2D}\) = 0.390.}
...
%   \textbf{FLEXIBLE} \\
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[width=.99\textwidth]{g_r_6_46_f_o_o}
%    \vspace{-15pt} \caption{}
%    \label{fig:rg_6_f}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[width=.99\textwidth]{g_r_7_46_f_o_o}
%     \vspace{-15pt} \caption{}
%    \label{fig:rg_7_f}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[width=.99\textwidth]{g_r_8_46_f_o_o}
%    \vspace{-15pt} \caption{}
%    \label{fig:rg_8_f}
%  \end{subfigure}
%    \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[width=.99\textwidth]{g_r_9_46_f_o_o}
%    \vspace{-15pt} \caption{}
%    \label{fig:rg_9_f}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[width=.99\textwidth]{g_r_12_46_f_o_o}
%     \vspace{-15pt} \caption{}
%    \label{fig:rg_12_f}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[width=.99\textwidth]{g_r_14_46_f_o_o}
%    \vspace{-15pt} \caption{}
%    \label{fig:rg_14_f}
%  \end{subfigure} \\  \vspace{-10pt} 
% % \hfill
% \textbf{RIGID} \\
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[width=.99\textwidth]{g_r_6_46_r_o_o}
%     \vspace{-15pt} \caption{}
%    \label{fig:rg_6_r}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[width=.99\textwidth]{g_r_7_46_r_o_o}
%     \vspace{-15pt} \caption{}
%    \label{fig:rg_7_r}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[width=.99\textwidth]{g_r_8_46_r_o_o}
%    \vspace{-15pt} \caption{}
%    \label{fig:rg_8_r}
%  \end{subfigure}
%   \begin{subfigure}[b]{0.15\textwidth}
%  \includegraphics[width=.99\textwidth]{g_r_9_46_r_o_o}
%    \vspace{-15pt} \caption{}
%    \label{fig:rg_9_r}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[width=.99\textwidth]{g_r_12_46_r_o_o}
%     \vspace{-15pt} \caption{}
%    \label{fig:rg_12_r}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.15\textwidth}
%    \includegraphics[width=.99\textwidth]{g_r_14_46_r_o_o}
%    \vspace{-15pt} \caption{}
%    \label{fig:rg_14_r}
%  \end{subfigure}\\
%  \caption{\textit{Oxygen-oxygen radial distribution functions} (\protect\subref{fig:rg_6_f},\protect\subref{fig:rg_6_r})  \(\rho_{2D}\) = 0.065 (\protect\subref{fig:rg_7_f},\protect\subref{fig:rg_7_r}) \(\rho_{2D}\) = 0.097 (\protect\subref{fig:rg_8_f},\protect\subref{fig:rg_8_r}) \(\rho_{2D}\) = 0.129, (\protect\subref{fig:rg_9_f},\protect\subref{fig:rg_9_r}) \(\rho_{2D}\) = 0.163, (\protect\subref{fig:rg_12_f},\protect\subref{fig:rg_12_r}) \(\rho_{2D}\) = 0.260 (\protect\subref{fig:rg_14_f},\protect\subref{fig:rg_14_r}) \(\rho_{2D}\) = 0.325.}
%  \label{fig:gr}
%\end{figure}

%\begin{figure}[h!]
%	\centering
%	(a)~\includegraphics[width=0.11\linewidth]{6A_f2} 
%	\includegraphics[width=0.24\linewidth]{6A_f3}
%	(b)~\includegraphics[width=0.15\linewidth]{6A_r2} 
%	\includegraphics[width=0.39\linewidth]{6A_r3}
...
%	\centering
%	\begin{subfigure}[b]{0.49\textwidth}
%    \includegraphics[trim={0.25cm 0.25cm 0.25cm 0.15cm},clip,width=\textwidth]{msd_2D_f}
%     \vspace{-15pt} \caption{}
%    \label{fig:msd_f}
%  \end{subfigure}
%  \begin{subfigure}[b]{0.49\textwidth}
%    \includegraphics[trim={0.25cm 0.25cm 0.25cm 0.15cm},clip,width=1\textwidth]{msd_2D_r}
%     \vspace{-15pt} \caption{}
%    \label{fig:msd_r}
%  \end{subfigure}
%	\caption{\textit{Water in-plane mean square displacement}. Mean squared in-plane displacement of water molecules (\protect\subref{fig:msd_f}) flexible systems, (\protect\subref{fig:msd_r}) rigid systems. The inserts plot the estimated diffusion coefficient as a function of number density.}
%	\label{fig:msd_both}
%\end{figure}
