...
%	(e)~\includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=0.15\linewidth]{ang_3B_14_46_f} \\
%	\textbf{RIGID} \\
...
%	(j)~\includegraphics[trim={0.3cm 0.25cm 0.25cm 0.15cm},clip,width=0.15\linewidth]{ang_3B_14_46_r}
 ...
 \textbf{RIGID} \\
  ...
  \begin{subfigure}[b]{0.15\textwidth}
    ...
    \label{fig:ang_14_r}
  \end{subfigure}\\
	\caption{\textit{3-body angle distribution functions} Distribution of angle formed between nearest neighbors  (\protect\subref{fig:rg_6_f},\protect\subref{fig:rg_6_r})  \(\rho_N\) = 0.065 (\protect\subref{fig:ang_7_f},\protect\subref{fig:ang_7_r}) \(\rho_N\) = 0.097 (\protect\subref{fig:ang_8_f},\protect\subref{fig:ang_8_r}) \(\rho_N\) = 0.129, (\protect\subref{fig:ang_9_f},\protect\subref{fig:ang_9_r}) \(\rho_N\) = 0.163, (\protect\subref{fig:ang_12_f},\protect\subref{fig:ang_12_r}) \(\rho_N\) = 0.260 (\protect\subref{fig:ang_14_f},\protect\subref{fig:ang_14_r}) \(\rho_N\) = 0.325.}
...
%	(a)~\includegraphics[trim={0.25cm 0.25cm 0.25cm 0.15cm},clip,width=0.28\linewidth]{ang_3B_6_46_f} 
%	(b)~\includegraphics[trim={0.25cm 0.25cm 0.25cm 0.15cm},clip,width=0.28\linewidth]{ang_3B_7_46_f}
%	(c)~\includegraphics[trim={0.25cm 0.25cm 0.25cm 0.15cm},clip,width=0.28\linewidth]{ang_3B_8_46_f}
%	\textbf{RIGID} \\
...
%	(f)~\includegraphics[trim={0.25cm 0.25cm 0.25cm 0.15cm},clip,width=0.28\linewidth]{ang_3B_6_46_r} 
%	(g)~\includegraphics[trim={0.25cm 0.25cm 0.25cm 0.15cm},clip,width=0.28\linewidth]{ang_3B_7_46_r}
%	(h)~\includegraphics[trim={0.25cm 0.25cm 0.25cm 0.15cm},clip,width=0.28\linewidth]{ang_3B_8_46_r}
%	\vspace{-10pt}
...
\end{figure}
 ...
 \textbf{RIGID} \\
  ...
  \begin{subfigure}[b]{0.15\textwidth}
    ...
    \label{fig:rg_14_r}
  \end{subfigure}\\
  \caption{\textit{Oxygen-oxygen radial distribution functions} (\protect\subref{fig:rg_6_f},\protect\subref{fig:rg_6_r})  \(\rho_N\) = 0.065 (\protect\subref{fig:rg_7_f},\protect\subref{fig:rg_7_r}) \(\rho_N\) = 0.097 (\protect\subref{fig:rg_8_f},\protect\subref{fig:rg_8_r}) \(\rho_N\) = 0.129, (\protect\subref{fig:rg_9_f},\protect\subref{fig:rg_9_r}) \(\rho_N\) = 0.163, (\protect\subref{fig:rg_12_f},\protect\subref{fig:rg_12_r}) \(\rho_N\) = 0.260 (\protect\subref{fig:rg_14_f},\protect\subref{fig:rg_14_r}) \(\rho_N\) = 0.325.}
  \label{fig:gr}
\end{figure}
